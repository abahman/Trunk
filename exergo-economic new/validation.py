...
host.plot(x1,y1,'ro',label=r'Bertsch et al. (2008) ($\mathrm{COP_{H}}$)')
host.plot(x1,y2,'r-',label=r'Present study ($\mathrm{COP_{H}}$)') 

par2.plot(x2,y3,'bs',label=r'Cao et al. (2014) ($\mathrm{COP_{H}}$)') 
par2.plot(x2,y4,'b-',label=r'Present study ($\mathrm{COP_{H}}$)')

par3.plot(x2,y5,'g^',label=r'Cao et al. (2014) ($\eta_{ex}$)') 
par3.plot(x2,y6,'g-',label=r'Present study ($\eta_{ex}$)')
...
par2.set_xlim(96, 110)
par3.set_xlim(96, 110)
par1.set_ylim(39, 49)
...
par2.set_xlabel(r'$T_{cond}$ [$\degree$C]')
