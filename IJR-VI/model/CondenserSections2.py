...
img = pylab.imshow(gradient, extent=[0,4.01,0,0.999], alpha=0.9, aspect=4, cmap=plt.get_cmap('brg'))
...
imgplot = pylab.imshow(gradient2, extent=[-0.01,4.01,-1.7,-0.71], alpha=0.9, aspect=4, cmap=plt.get_cmap('brg'))
