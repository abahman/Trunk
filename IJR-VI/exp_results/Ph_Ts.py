...
plt.plot(B_h,B_P,'-*',linewidth=1.5,alpha=0.9,label='No injection')
plt.plot(VI_7K_h,VI_7K_P,'r--X',linewidth=1.5,alpha=0.9, label='$T_{sup}$ = 7 K')
plt.plot(VI_7K_h1,VI_7K_P1,'r--X',linewidth=1.5,alpha=0.9)
plt.plot(VI_7K_h2,VI_7K_P2,'r--X',linewidth=1.5,alpha=0.9)
plt.plot(VI_0K_h,VI_0K_P,'g:P',linewidth=1.5,alpha=0.9,label='$T_{sup}$ = 0 K')
...
plt.plot(B_s,B_T,'-*',linewidth=1.5,alpha=0.9,label='No injection')
plt.plot(VI_7K_s,VI_7K_T,'r--X',linewidth=1.5,alpha=0.9, label='$T_{sup}$ = 7 K')
plt.plot(VI_7K_s1,VI_7K_T1,'r--X',linewidth=1.5,alpha=0.9)
plt.plot(VI_7K_s2,VI_7K_T2,'r--X',linewidth=1.5,alpha=0.9)
plt.plot(VI_0K_s,VI_0K_T,'g:P',linewidth=1.5,alpha=0.9,label='$T_{sup}$ = 0 K')
