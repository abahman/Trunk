...
def DryWetSegment(DWS):
    ...
    if DWS.IsTwoPhase: #(Two-Phase analysis)
        ...
        epsilon_dry=1-exp(-Ntu_dry);  #since Cr=0, e.g. see Incropera - Fundamentals of Heat and Mass Transfer, 2007, p. 690 or p.689 (11.35a) in sixth edition 
        ...
        if T_so_b>Tdp:
            ...
            # Wet effectiveness [-]
            epsilon_wet=1-exp(-(1-f_dry)*Ntu_wet)   #all heat exchangers for phase change on one side, 689 Incropera sixth edition
