...
pylab.plot(np.r_[2.75,2.75],np.r_[-y0,-y0+1],'k-.')
pylab.gca().text(1.5,-y0+0.5,'Two-Phase',ha='center',va='center')
pylab.gca().text(3.375,-y0+0.5,'Superheated',ha='center',va='center')
pylab.gca().text(2.5,0,'Returned Air',ha='center',va='center')
pylab.gca().text(2.5,-2.5,'Supply Air',ha='center',va='center')
pylab.gca().text(-0.75,-1.7,'Refrigerant\n from TXV',ha='center',va='center')
pylab.gca().text(4.75,-.7,'Refrigerant\n to suction line',ha='center',va='center')
...
t1 = ax.text(1.5, -0.25, " BCDE", color="w", ha="center", va="center", rotation=-90,
            size=6,
            bbox=bbox_props)
t2 = ax.text(1.5, -2.1, " BCDE", color="w", ha="center", va="center", rotation=-90,
            size=6,
            bbox=bbox_props)
...
t4 = ax.text(3.375, -2.1, " BCDE", color="w", ha="center", va="center", rotation=-90,
            size=6,
            bbox=bbox_props)
t5 = ax.text(-0.5, -1.7+0.5, " BCDE", color="w", ha="center", va="center", rotation=0,
            size=6,
            bbox=bbox_props)
t6 = ax.text(4.5, -1.7+0.5, " BCDE", color="w", ha="center", va="center", rotation=0,
            size=6,
            bbox=bbox_props)
...
pylab.gca().axis('off')
pylab.savefig('evaporator_sections.pdf')
pylab.show()