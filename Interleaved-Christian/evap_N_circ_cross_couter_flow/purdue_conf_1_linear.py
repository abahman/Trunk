...
def airside_maldistribution_study(evap_type='LRCS',MD_Type=None,interleave_order=None,MD_severity=None,airside_maldistributions=None,num_evaps=2,filenameMDair='debug.csv',Hybrid='equal_flow',adjust_area_fraction_iternum=10,Target_SH=5):
    #===========================================================================
    # Main Function
    #===========================================================================
    ...
    if MD_Type==None:
        ...
        Original_Profile=np.array([0.5,0.417,0.334,0.167,0.0834,0.])*6.0 #Test fan only #Update on 04/11/16
        ...
        filenameMDair =evap_type+'-6Circuit_airMD_Ammar_purdue_conf_T_sup='+str(Target_SH)+'.csv'
...
if __name__=='__main__':
    ...
    if 0:
        ...
        #run parametric studies
            airside_maldistribution_study(evap_type='60K',MD_Type="60K",Target_SH=T_SH)
        ...
        for T_SH in [5,10,15]:
            for md_type in ['linear']:
                ...
                if 1:
                    ...
                    airside_maldistribution_study(evap_type='60K',MD_Type=md_type,interleave_order=maldistributions[2],MD_severity=MD_severity,airside_maldistributions=maldistributions[0],num_evaps=Number_cir,filenameMDair='60K_Ammar_purdue_conf_'+md_type+'_T_sup='+str(T_SH)+'.csv',Target_SH=T_SH)
