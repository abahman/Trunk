...
#     df = pd.read_excel('correlation_results.xlsx',sheetname=condition[i]+'_injection_rate',header=0) #file name
#     #assign axes
...
#     plt.tight_layout()       
#     #plt.savefig(condition[i]+'_parity_m_inj.pdf')
#     #plt.show()
#     plt.close()
#   
#     #########################
...
#      
#     #error axes
#     error = [0.03,0.01,0.03] #error of ['Total','Two_phase','Vapor']
#     w=error[i] #Error
#     ax_min = 2500
...
# plt.xlabel('$\dot m_{inj}$/$\dot m_{suc}$ measured [\%]')
# plt.tight_layout()       
# #plt.savefig('Dardenne_parity_m_inj.pdf')
# #plt.show()
# plt.close()
# 
# #########################
