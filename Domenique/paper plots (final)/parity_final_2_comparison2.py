...
df_total = pd.read_excel('correlation_results.xlsx',sheetname='Total_injection_rate',header=0) #file name
df_vapor = pd.read_excel('correlation_results.xlsx',sheetname='Vapor_injection_rate',header=0) #file name
df_two_phase = pd.read_excel('correlation_results.xlsx',sheetname='Two_phase_injection_rate',header=0) #file name
df_dardenne = pd.read_excel('correlation_results.xlsx',sheetname='Dardenne_injection_rate',header=0) #file name
...
plt.tight_layout()       
#plt.savefig('All_parity_m_inj_comparison.pdf')
#plt.show()
plt.close()
...
ax.set_xlim((ax_min,ax_max))
ax.set_ylim((ax_min,ax_max))
plt.ylabel('$\dot W$ predicted [\%]')
plt.xlabel('$\dot W$ measured [\%]')
plt.tight_layout()       
