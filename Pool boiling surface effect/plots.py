...
plt.annotate('Transition boiling',xy=(0,0),xytext=(56,27),annotation_clip=False,fontsize=12,backgroundcolor="w")
plt.annotate('Film boiling',xy=(0,0),xytext=(335,200),annotation_clip=False,fontsize=12,backgroundcolor="w")
