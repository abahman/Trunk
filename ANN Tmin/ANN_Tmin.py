...
def Calculate():
    ...
    if mode == 'training':
        ...
        hidden1 = Dense(100, activation='tanh')(merged) #hidden1 = Dense(256, activation='tanh')(merged)
        hidden2 = Dense(100, activation = 'tanh')(hidden1)
        ...
        output1 = Dense(1, activation = 'linear',name='Tmin')(hidden3) #output1 = Dense(1, activation = 'linear',name='m_gas')(hidden3)
        ...
        model.compile(optimizer='adamax',loss=['mse']) #model.compile(optimizer='adamax',loss=['mse','mse','mse','mse','mse','mse'])
